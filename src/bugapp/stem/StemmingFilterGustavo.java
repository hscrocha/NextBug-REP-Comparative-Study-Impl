...
//
///**
// * The filter responsible for stemming the identifiers.
// * @author Samuel Medeiros
// */
//public class StemmingFilterGustavo extends BugAppStemmingFilter {
//
//    @Override
//    public String processWord(String Word) throws Exception {
//        
//        if(Word.length()<2){
//            //Stop word não fazer nada.
//            return null;
//        }else if(!isProcessable(Word) || Word.length()<=4){
//            return Word;
//        }
//        else{ 
//            System.out.printf("%n Word: %s Stem[",Word);
//            MyStemmingAnalyzer stAn = new MyStemmingAnalyzer();
//            StringReader strd = new StringReader(Word.toLowerCase());
//            TokenStream tokstream = stAn.tokenStream(strd);
//
//            Token Current = tokstream.next();
//            if (Current != null) {
//                System.out.print(Current.termText());
//                return (Current.termText());
//            }
//            else{
//                return Word;
//            }
...
//    }
//    
//    private boolean isProcessable(String Word){
//        if(Word.startsWith("0x")){ //número hexadecimal
//            return false;
//        }
//        
//        return true;
...
//    
//    //@Override
//    public List<String> processIdentifiers(List<String> identifiers) {
//        MyStemmingAnalyzer stemmingAnalyzer = new MyStemmingAnalyzer();
//        List<String> newIdentifiers = new ArrayList<String>();
//
//        for (String s : identifiers) {
//            StringReader stringReader = new StringReader(s);
//            TokenStream tokenStream = stemmingAnalyzer.tokenStream(stringReader);
//
//            Token currentToken;
//            try {
//                while ((currentToken = tokenStream.next()) != null) {
//                    newIdentifiers.add(currentToken.termText());
//                }
//            } catch (IOException e) {
//                e.printStackTrace();
//            }
...
//     * @author Samuel Medeiros
//     */
//    private class MyStemmingAnalyzer extends Analyzer {
//
//        @Override
//        public TokenStream tokenStream(Reader reader) {
//            return new MyPorterStemFilter(new LetterTokenizer(reader));
//        }
//    }
//
//    /**
...
//     * @author samuel Medeiros
//     */
//    private class MyPorterStemFilter extends TokenFilter {
//
//        private MyPorterStemmer stemmer;
//
...
//                return null;
//            } else {
//                // TODO Antes daqui, ja recebe separado por _
...
//            return new String(originalToken.toCharArray(), 0, i);
//        }
//
//        /**
...
//            originalToken = s;
//            if (stem(s.toLowerCase().toCharArray(), s.length())) {
//                return toString();
//            } else {
//                return s;
//            }
...
//         * each word, writing the result to standard out. Usage: Stemmer
//         * file-name
//         */
//        /*
//         * public static void main(String[] args) { PorterStemmer s = new
//         * PorterStemmer();
//         * 
//         * for (int i = 0; i < args.length; i++) { try { InputStream in = new
//         * FileInputStream(args[i]); byte[] buffer = new byte[1024]; int
//         * bufferLen, offset, ch;
//         * 
//         * bufferLen = in.read(buffer); offset = 0; s.reset();
//         * 
//         * while(true) { if (offset < bufferLen) ch = buffer[offset++]; else {
//         * bufferLen = in.read(buffer); offset = 0; if (bufferLen < 0) ch = -1;
//         * else ch = buffer[offset++]; }
//         * 
//         * if (Character.isLetter((char) ch)) {
//         * s.add(Character.toLowerCase((char) ch)); } else { s.stem();
//         * System.out.print(s.toString()); s.reset(); if (ch < 0) break; else {
